...
//configuração do banco de dados
    ...
    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION); // DEFINE QUE ERROS SERÃO LANÇADOS COMO EXCEÇÕES
    ...
    if(isset($_GET['id'])){
        ...
        // VERIFICA SE ENCONTROU O FUNCIONARIO
            ...
            //LINHA ABAIXO VERIFICA SE OS DADOS FRAM ENVUADOS VUA FORMULARIO COM O METODO POST
            ...
            if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['excluir_id'])){ 
                ...
                //monta a query sql para deletar o funcionario om o id correspondente
...
<body>
    ...
    <p>Foto:</p>
            <img src="data: <?$funcionario['tipo_foto']?>;base64,<?=base64_encode($funcionario['foto'])?>" alt="Foto do Funcionario"></img>
...
<?php
        ...
        echo "ID do funcionario nao foi fornecido.";
    } 
